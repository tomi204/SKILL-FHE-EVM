...
API; for the complete list of available operations see `references/fhe-ops-catalog.md`. For exact file/line
references by op, see `references/fhe-ops-usage-map.md`.
