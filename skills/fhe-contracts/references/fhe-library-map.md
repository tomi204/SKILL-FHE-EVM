...
- Zama FHEVM library: `<ZAMA_REPO>/node_modules/@fhevm/solidity/lib/FHE.sol`
- Fhenix CoFHE library: `<FHENIX_REPO>/node_modules/@fhenixprotocol/cofhe-contracts/FHE.sol`
...
```bash
rg -n "@fhevm/solidity/lib/FHE.sol" <ZAMA_REPO>/contracts
rg -n "@fhenixprotocol/cofhe-contracts/FHE.sol" <FHENIX_REPO>/contracts
```
